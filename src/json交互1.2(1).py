...
def edit_lockers():
    ...
    def edit_time_rulers():
        ...
        def add_rules(i=None):
            ...
            combobox_days=ttk.Combobox(frame,values=["说明：","请输入一个在1到7之间的数","或者预设的时间集","可以在presets中预设时间集"],textvariable=days)
...
def edit_count_tasks():
    ...
    def sure_count_tasks():
        ...
        if count_tasks_state.get()=="新建":
            ...
            id,name=data["count_tasks"][index]["id"],data["count_tasks"][index]["name"]
