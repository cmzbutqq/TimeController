...
__all__ = ('shorten','Any', 'Optional', 'Callable', 'Union' ,'Sequence','singleton','dataclass','noexception','timeit','timeme','dprint','datetime','timedelta','namedtuple','time','date','print','weakref')
